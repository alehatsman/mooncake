...
- internal/apply/doc.go — package doc that cites
  docs-working-v2/vision/kernel.md as the rationale for the
...
14. git add -A && git commit -m:
    ...
    See docs-working-v2/arch-report/2026-05-15-refactoring-plan.md
    §3 (R1.1a) and docs-working-v2/vision/kernel.md."
