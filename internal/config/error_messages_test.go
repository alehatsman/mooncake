...
func TestFormatOneOfError(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: "Step has no action. Each step must have exactly ONE of: shell, template, file, copy, service, assert, preset, include, include_vars, or vars",
		},
		{
			...
			expected: "Step has multiple actions. Only ONE action is allowed per step. Choose either: shell, template, file, copy, service, assert, preset, include, include_vars, or vars",
		},
		{
			...
			expected: "Step must have exactly one action (shell, template, file, copy, service, assert, preset, include, include_vars, or vars)",
		},
	}
