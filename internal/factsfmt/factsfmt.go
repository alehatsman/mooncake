// Package factsfmt renders system facts in a human-readable terminal
// format. It is the receive end of the `mooncake facts` command.
//
// Named factsfmt, not explain, because `mooncake explain <noun>`
// (spec-68) is a different resolver that lives in internal/explain.
package factsfmt
