// Package vars_load implements the vars.load action handler.
//
// The vars.load action loads variables from YAML files into the execution context.
// This is useful for organizing variables across multiple files.

//nolint:revive,staticcheck // vars_load name matches action name for consistency
package vars_load
