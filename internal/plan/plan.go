...
type Plan struct {
	...
	// executor can resolve `use: <alias>` references at apply time. Each
	// binding also carries any module-level default props (#52).
	Modules map[string]config.ModuleBinding `json:"modules,omitempty" yaml:"modules,omitempty"`
