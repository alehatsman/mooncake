...
| 3 | **(shipped)** proposal-16 `expect_json_schema` — closed 2026-05-27 alongside the `PresetBaseDir` cleanup (Node-style path resolution throughout). | core | — | [`archive/streams/core/proposals/done/proposal-16-http-request-action.md`](./archive/streams/core/proposals/done/proposal-16-http-request-action.md) | — |
