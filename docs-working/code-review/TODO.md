...
| F035 | vars action leaks !secret sentinel — planner pre-evaluates vars, bypasses resolver.Resolve | bug | S | — | open |
| F036 | shell line-overflow surfaces only via human logger — structured event/result stays silent above 1 MB | bug | XS | — | open |
...
| F033 | path-traversal validation silently ignored in repo.patch | risk | open | [findings/F033](./findings/F033-path-traversal-validation-silently-ignored.md) |
| F035 | vars action bypasses secrets resolver | bug | open | [findings/F035](./findings/F035-vars-action-bypasses-secrets-resolver.md) |
| F036 | shell line-overflow structured stream silent | bug | open | [findings/F036](./findings/F036-shell-line-overflow-structured-stream-silent.md) |
