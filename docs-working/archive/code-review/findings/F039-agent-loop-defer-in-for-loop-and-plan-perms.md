...
lines: 109-115, 214-223 (rebased after S-pilot-rename)
status: done
resolved_by: 475f280b
...
post-fix verified 2026-05-16 on master @ 0c7009cc — (a)+(b) shipped via applyPlanIteration helper (loop.go:107-...); tempfile defer now scopes per-call instead of per-loop-body, no accumulation; pilot tests green. (c)+(d) verified earlier
