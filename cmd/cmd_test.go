...
func TestCreateApp(t *testing.T) {
	...
	// Test commands exist
	expectedCommands := []string{"init", "doctor", "presets", "mod", "docs", "schema", "snapshot", "history", "mcp", "step", "task", "tool", "apply", "plan", "facts", "explain", "metrics", "actions", "validate", "pilot", "agentd", "fleet", "runs", "query"}
...
func TestPresetsCommand(t *testing.T) {
	...
	expectedSubcommands := []string{"search", "update", "registry", "add", "list", "info", "install", "status", "uninstall", "recommend"}
