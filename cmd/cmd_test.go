...
func TestCreateApp(t *testing.T) {
	...
	// Test commands exist
	expectedCommands := []string{"init", "doctor", "mod", "docs", "schema", "selfbuild", "snapshot", "history", "mcp", "step", "task", "tool", "apply", "plan", "facts", "explain", "metrics", "actions", "validate", "agent", "agentd", "fleet", "runs", "query"}
