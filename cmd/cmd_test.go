...
func TestCreateApp(t *testing.T) {
	...
	// Test commands exist
	expectedCommands := []string{"init", "doctor", "presets", "docs", "schema", "snapshot", "history", "mcp", "step", "tool", "apply", "plan", "facts", "metrics", "actions", "validate", "agent", "agentd", "fleet", "runs"}
