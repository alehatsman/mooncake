...
Prompts for the secret value (echo disabled), encrypts it for all
...
|------|------|---------|-------------|
| `--recipient / -r` | []string | - | Additional Age recipient public key (repeatable; supplements recipients.txt) |
